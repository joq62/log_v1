...
test_1()->
 ...
 %   yes=rpc:call(N2,mnesia,system_info,[],5000),
    ...
    true=rpc:cast(N2,log,notice,[?MODULE,?FUNCTION_NAME,?LINE,
			    "event 1",[event_info1]
			   ]),
    timer:sleep(1000),
    [
  ...
  %% N3
    ...
    true=rpc:cast(N1,log,notice,[?MODULE,?FUNCTION_NAME,?LINE,"event 2",[event_info2]]),
    true=rpc:cast(N2,log,warning,[?MODULE,?FUNCTION_NAME,?LINE,"warning1",[warning_info1]]),
    true=rpc:cast(N3,log,alert,[?MODULE,?FUNCTION_NAME,?LINE,"alert 1",[alert_info1]]),
 ...
 %% N4
    ...
    true=rpc:cast(N4,log,debug,[?MODULE,?FUNCTION_NAME,?LINE,"debug 1",[debug_info1]]),
